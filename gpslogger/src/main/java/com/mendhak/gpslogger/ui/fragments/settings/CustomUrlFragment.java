        ...
        if(preference.getKey().equals("customurl_legend_1")){
            ...
            String legendFormat =
                    "{1} <font color=''#{0}'' face=''monospace''>%LAT</font><br />" +
                            ...
                            "{26} <font color=''#{0}'' face=''monospace''>%BOTTOKEN</font><br />" +
                            "{27} <font color=''#{0}'' face=''monospace''>%CHATID</font><br />" +
                            "{28} <font color=''#{0}'' face=''monospace''>%NOHP</font><br />"
                            ;
            String legend1 = MessageFormat.format(legendFormat,
                    ...
                    getString(R.string.txt_travel_distance), getString(R.string.customurl_all_parameters)," bot_token","chat_id","no_hp");
