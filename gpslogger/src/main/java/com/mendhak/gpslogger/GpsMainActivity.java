...
import com.mendhak.gpslogger.darisms.main_activity;
import com.mendhak.gpslogger.darisms.notify_apps_list_activity;
...
//        }
    ...
    public void setUpNavigationDrawer(Bundle savedInstanceState) {
        ...
        materialDrawer.addItem(GpsLoggerDrawerItem.newPrimary(R.string.menu_sms, null, R.drawable.autosend, 1088));
            ...
            public boolean onItemClick(View view, int i, IDrawerItem iDrawerItem) {
                ...
                switch (iDrawerItem.getIdentifier()) {
                    ...
                    case 9000:
                        ...
                        break;
                    case 1088:
                        Intent teleSMS = new Intent(getApplicationContext(), main_activity.class);
                        startActivity(teleSMS);
                        break;
                    case 9001:
    ...
    private void startAndBindService() {
        ...
        if (!service_func.is_notify_listener(getApplicationContext())) {
