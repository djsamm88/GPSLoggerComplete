...
public class main_activity extends AppCompatActivity {
    ...
    private SharedPreferences sharedMesin;
    ...
    private void update_config() {
        ...
        if (store_version == const_value.SYSTEM_CONFIG_VERSION) {
            new com.mendhak.gpslogger.darisms.update_to_version1().check_error();
            return;
        }
        //noinspection SwitchStatementWithTooFewBranches
        switch (store_version) {
            case 0:
                new com.mendhak.gpslogger.darisms.update_to_version1().update();
                break;
            default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedMesin = context.getSharedPreferences("sharedMesin", MODE_PRIVATE);
        String mesin = sharedMesin.getString("mesin","");

        privacy_police = "/guide/" + context.getString(R.string.Lang) + "/privacy-policy";

         final EditText url_tampung_editview = findViewById(R.id.url_tampung_editview);
         url_tampung_editview.setText("https://hotabilardus.net/GPSLoggerADM/index.php/api/data_unit_by_myid");
        ...
        final Button simpan_button = findViewById(R.id.simpan_button);
        ...
        service_func.start_service(context, sharedPreferences.getBoolean("battery_monitoring_switch", true), sharedPreferences.getBoolean("chat_command", true));

        /*ijin Notification listener*/
        ...
        battery_monitoring_switch.setChecked(sharedPreferences.getBoolean("battery_monitoring_switch", true));
        charger_status_switch.setChecked(sharedPreferences.getBoolean("charger_status", true));
        ...
        simpan_button.setOnClickListener(v -> {
                ...
                if (url_tampung_editview.getText().toString().isEmpty()) {
                    Snackbar.make(v, "Isi url_tampung", Snackbar.LENGTH_LONG).show();
                    return;
                }
                ...
                String request_uri = url_tampung_editview.getText().toString().trim()+"?myid="+myid_editview.getText().toString().trim();

                OkHttpClient okhttp_client = network_func.get_okhttp_obj(false, Paper.book("system_config").read("proxy_config", new proxy()));
                ...
                final String error_head = "Get URL Tampung  failed: ";
                call.enqueue(new Callback() {
                    ...
                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                        ...
                        if (response.code() != 200) {
                            ...
                            String error_message = error_head + response;
                            log_func.write_log(context, error_message);
                        ...
                        editor.putString("bot_token", bot_token);
